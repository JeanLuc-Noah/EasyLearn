...
<body>
    ...
    <div class="container--title">
        <div class="title">
            <h2>Ajouter <span>une</span> nouvelle <span>formation</span></h2>
            <p>Vous pouvez publier maintenant un nouvellee formation</p>
        </div>
        ...
        <div class="container--contents-formulaire">
            ...
            <div class="group-formulaire">
                ...
                <form method="POST" action="" class="group-form" enctype="multipart/form-data">
                    ...
                    <div class="block-input">
                        <input type="text" name="sous_titre" value="sous-testing" placeholder="Sous-titre">
                    </div>
                    ...
                    <div class="block-input">
                        <input type="time" name="nbr_heure" placeholder="Nombre d'heure">
                    </div>

                    <div class="block-textarea">
                        <textarea name="description" id="editor1" rows="10" cols="80" placeholder="Contenus du sujet....">ceci est un test de test</textarea>
                    </div>
                    <div class="block-input">
